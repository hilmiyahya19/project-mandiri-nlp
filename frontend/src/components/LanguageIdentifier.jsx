...
//     try {
//       const response = await fetch("http://127.0.0.1:5000/identify_language", {
//         method: "POST",
...
//       <h1 className="text-2xl font-bold text-gray-800 mb-6">Language Identifier</h1>
//       <textarea
...
//             <strong>Detected Language:</strong> {result.detected_language_name} ({result.detected_language})
//           </p>
//           <h3 className="mt-4 text-lg font-semibold text-gray-800">Possible Languages:</h3>
...
//               >
//                 {lang.language_name} ({lang.language}) - {Math.round(lang.probability * 100)}%
//               </li>
//             ))}
//           </ul>
//         </div>
